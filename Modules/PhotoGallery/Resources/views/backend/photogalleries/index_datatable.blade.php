                ...
                <div class="col">
                    <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                        ...
                        <tr>
                            ...
                            <th>
                                @lang("photogallery::text.updated_at")
                            </th>
                            <th class="text-end">
                                @lang("photogallery::text.action")
                            </th>
                        </tr>
                        </thead>
                    </table>
...
@push ('after-scripts')
    ...
    <script type="module">
        const datatableTable = $('#datatable');
        datatableTable.DataTable({
            processing: true,
            serverSide: true,
            responsive: true,
            ajax: '{{ route("backend.$module_name.gallery_list") }}',
            columns: [
                {
                    data: 'id',
                    name: 'id'
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        return '<img src="' + data + '" alt="Image" height="50" onerror="this.onerror=null;this.src=\'/images/placeholder.png\';" />';
                    }
                },
        ...
        datatableTable.on('click', '.delete-button', function(e) {
            e.preventDefault();
