...
Route::get('product-list', [FrontendController::class, 'productList'])->name('products_list');
Route::get('contacts', [FrontendController::class, 'contactPage'])->name('contact_page');
Route::get('restaurants', [FrontendController::class, 'restaurantPage'])->name('restaurants');
Route::get('photo-gallery', [FrontendController::class, 'photoGallery'])->name('photo_gallery');
