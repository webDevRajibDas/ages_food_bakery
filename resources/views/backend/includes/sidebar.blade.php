...
<div class="sidebar sidebar-dark sidebar-fixed border-end" id="sidebar">
    <div class="sidebar-header border-bottom">
        <div class="sidebar-brand d-sm-flex justify-content-center">
            <a href="/">
                <img class="sidebar-brand-full" src="{{ asset('img/Chaity_Logo-min.png') }}" alt="{{ app_name() }}"
                    height="56" width="100">
                <img class="sidebar-brand-narrow" src="{{ asset('img/Chaity_Logo-min.png') }}" alt="{{ app_name() }}"
                    height="46">
            </a>
        </div>
    ...
    <ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
        ...
        <li class="nav-group" aria-expanded="true">
            <a class="nav-link nav-group-toggle" href="#">
                <i class="nav-icon fa-solid fa-list-ul"></i>&nbsp;@lang('Home Page')
            </a>
            <ul class="nav-group-items compact" style="height: auto;">
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <span class="nav-icon"><span class="nav-icon-bullet"></span></span> Slider
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <span class="nav-icon"><span class="nav-icon-bullet"></span></span> At Glance Number
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <span class="nav-icon"><span class="nav-icon-bullet"></span></span> Welcome Section
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <span class="nav-icon"><span class="nav-icon-bullet"></span></span> Home Concept
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <span class="nav-icon"><span class="nav-icon-bullet"></span></span>Big Hero Section
                    </a>
                </li>
            </ul>
        </li>
        ...
        @php
            $module_name = "photogalleries";
            $text = __('Photo Gallery');
            $icon = "fa-regular fa-file-lines";
            $permission = "view_".$module_name;
            $url = route('backend.'.$module_name.'.index');
        @endphp
